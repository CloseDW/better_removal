package com.better_removal.crabbersdelight;
 ...
 *   1-9  捕获物槽
 *
 * 该方块实体实现了原版 {@link net.minecraft.world.WorldlyContainer}（Mojang 映射），
 * 因此可直接作为 {@link net.minecraft.world.Container} 用标准方法访问物品。
 */

...
import com.better_removal.networking.ExtractionModeSetPacket;
...
public final class ModeWheel {
	...
	public static void commit() {
		...
		if (!preset.equals(ExtractionModeManager.getClientState())) {
			BetterRemovalNetwork.CHANNEL.sendToServer(new ExtractionModeSetPacket(preset.action(), preset.mode()));
		}
	}

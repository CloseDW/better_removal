package com.better_removal.aether;
 ...
 *   2    输出
 *
 * 该方块实体继承自原版 {@link net.minecraft.world.level.block.entity.AbstractFurnaceBlockEntity}，
 * 因此实现原版 {@link net.minecraft.world.Container} 接口，可直接转型用标准方法访问物品。
 */
